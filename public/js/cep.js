/* ############################################ Funcao CEP
Funcao para busca automática do endereço via CEP
*/

/*
- #cep é o id criado automáticamente pelo django
- this.$address = this.getData("autocomplete-address");
  ...
  Esta parte trabalha em conjungo com os widgets criados no forms_address.py
*/
$(function(){
